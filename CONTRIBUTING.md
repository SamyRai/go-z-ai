...
The project's static docs site is generated by a standalone tool,
[`sitegen`](https://go.glpx.pro/sitegen) (extracted from this repo). It is no
longer built or deployed from here; see that project to render the site from
this repo's markdown.
