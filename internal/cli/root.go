...
func init() {
	...
	rootCmd.PersistentFlags().String("region", "", "Regional gateway for monitor/biz/agents: 'global' (api.z.ai, default) or 'china' (open.bigmodel.cn). Does not override --base-url.")
